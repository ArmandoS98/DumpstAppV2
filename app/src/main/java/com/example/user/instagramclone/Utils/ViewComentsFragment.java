...
public class ViewComentsFragment extends Fragment {

    private static final String TAG = "ViewComentsFragment";

    public ViewComentsFragment(){
        super();
